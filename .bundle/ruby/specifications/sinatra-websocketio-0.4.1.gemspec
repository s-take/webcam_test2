...
Gem::Specification.new do |s|
  s.name = "sinatra-websocketio"
  s.version = "0.4.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Sho Hashimoto"]
  s.date = "2013-10-05"
  s.description = "WebSocket component for Sinatra RocketIO"
  s.email = ["hashimoto@shokai.org"]
  s.homepage = "https://github.com/shokai/sinatra-websocketio"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "2.0.14"
  s.summary = "WebSocket component for Sinatra RocketIO"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<websocket-client-simple>, [">= 0"])
    else
      ...
      s.add_dependency(%q<websocket-client-simple>, [">= 0"])
    end
  else
    s.add_dependency(%q<bundler>, ["~> 1.3"])
    s.add_dependency(%q<rake>, [">= 0"])
